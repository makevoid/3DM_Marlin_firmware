...
#define EXTRUDE_MINTEMP 155 // default is 170
...
// x, y, z, e
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {55.172,  55.172,  2560, 11000} // big pulleys
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,          80,  2560, 8000} // small pulleys

...
#define STRING_CONFIG_H_AUTHOR "3DMaking"  // Who made the changes.
...
#define HEATER_0_MINTEMP 5 // kentstrapper uses 0
...
#define INVERT_Y_DIR true   // for 3dm1: false, for prusa i2: true 
#define INVERT_Z_DIR true  // for 3dm1: false, for prusa i2: true 
#define INVERT_E0_DIR true  // strange, fix cable issue?   // for direct drive extruder v9 set to true, for geared extruder set to false
